...
const subData=[
  ...
  {id:2 ,name:<Link to='/ghee'  style={{color:'black',textDecoration:'none'}}>YOGURT </Link> },
  {id:3 ,name:<Link to='/yougert'  style={{color:'black',textDecoration:'none'}}>PURE GHEE</Link> },
